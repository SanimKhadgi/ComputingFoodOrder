                  ...
                  $heading = $fil['heading'];             
                    ...
                    ?>
                     <tr>
                        ...
                        <td><a class="btn btn-default" href="show_data.php?id=<?php echo $id ; ?>">Show</a> <input type="button"  class="btn btn-danger" onClick="deleteme(<?php echo $id ; ?>)" value="Delete"></td>
                      </tr>
