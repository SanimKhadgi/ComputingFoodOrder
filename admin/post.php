            ...
            <div class="list-group">
              <a href="index.php" class="list-group-item active main-color-bg">
                ...
                include'connect.php';
                 ...
                 $getdata = "select * from award_background_keshav";
              ...
              <a href="posts.php" class="list-group-item"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Posts <span class="badge"><?php echo $num ; ?></span></a>
              ...
              <div class="panel-body">
                <form action="edit.php" enctype="multipart/form-data" method="post">
                 ...
                 if(isset($_REQUEST['id'])){
                   ...
                   $id = $_REQUEST['id'];
                  $getdata = "select * from award_background_keshav where id = $id ";
                   $que = mysqli_query($con, $getdata);
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder=" Title" value="<?php  echo $heading ;     ?>">
                    <label>Subtitle</label>
                    <input type="text" class="form-control" placeholder="subtitle" value="<?php  echo $sub_heading ;  ?>">
                  </div>
                  <div class="form-group">
               ...
               <?php 
                      ...
                      if(isset($_POST['update'])){
                        ...
                        // for image ..............
                         $getdata = "select * from $e_data where id=$id";
                         $que = mysqli_query($con, $getdata); 
                         $array = mysqli_fetch_array($que);

                         echo $img  = $array['picture'];
                       ...
                       $update = "UPDATE $e_data SET heading ='$heading', sub_heading = '$sub_heading',content = '$content',picture = '$image' WHERE id = '$id'";
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          <label>Page Title</label>
          <input type="text" name="heading" class="form-control" placeholder="Page Title">
        </div>
        <div class="form-group">
